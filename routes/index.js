...
const initCountryRoutes = require('./country.routes')
const initTrademarkRoutes = require('./trademark.routes')
const initFrequencyRoutes = require('./frequency.routes')
const initProductCategoryRoutes = require('./product_category.routes')
